...
-   `$ sudo dscl . -change /Users/aminulmomin RecordName aminulmomin momin` -> Rename the account
-   `$ sudo mv /Users/aminulmomin /Users/momin` -> Rename the home directory
-   `$ sudo dscl . -change /Users/momin NFSHomeDirectory /Users/aminulmomin /Users/momin` -> Update the home-directory path
-   `$ sudo dseditgroup -o checkmember -m momin admin` -> Make sure the account is still an administrator
-   `$ sudo dseditgroup -o edit -a momin -t user admin` -> Make sure the account is still an administrator If it isn't a member of the admin group.
-   `$ ` -> 
-   `$ ` -> 
-   `$ ` -> 